...
import { FaFileInvoice, FaLock } from 'react-icons/fa';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between lg:justify-center gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to={isAdmin ? '/' : '/memberships/all'}>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {user?.role === 'admin' ? (
                ...
                <NavLink
                  to="/attendance/history"
                  className={`group rounded-lg relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out ${
